...
![Tanzu reference design diagram for air-gap deployment](.//img/reference-designs/tko-on-aws-airgap/tkg-aws-airgap-overview.png)
...
![TKG AWS network overview diagram](.//img/reference-designs/tko-on-aws-airgap/tkg-aws-airgap-network.png)
...
![TKG on AWS with Multiple VPCs and Multiple Availability Zones diagram](.//img/reference-designs/tko-on-aws-airgap/tkg-aws-multi-vpc-multi-az.png)
...
![TKG on AWS with Segregated VPCs for control plane and workloads diagram](.//img/reference-designs/tko-on-aws-airgap/tkg-aws-multi-vpc-multi-az-separated-control-plane-and-workloads.png)
...
![Tanzu Kubernetes Grid Kickstart Install Screen](.//img/reference-designs/tko-on-aws-airgap/tkg-kickstart-install.png)  
...
![Authentication with Pinniped](.//img/reference-designs/tko-on-aws-airgap/authwith-Pinniped.png)
...
![Monitoring Workflow](.//img/reference-designs/tko-on-aws-airgap/monitor-workflow.png)
...
![Resources Utilization Dashboard](.//img/reference-designs/tko-on-aws-airgap/gra-resource-utli.png)


**Namespace (Pods) Networking Utilization Dashboard**

![Networking Utilization Dashboard](.//img/reference-designs/tko-on-aws-airgap/gra-network-util.png)

**API Server Availability Dashboard**

![API Server Availability Dashboard](.//img/reference-designs/tko-on-aws-airgap/gra-api-server-avail.png)

**Cluster Compute Resources Utilization Dashboard**

![Cluster Compute Resources Utilization Dashboard](.//img/reference-designs/tko-on-aws-airgap/gra-cluster-comp-util.png)
