...
4.  Follow the wizard to configure the following:
   ...
   ![Completed configuration of the NSX Advanced Load Balancer controller node](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT01.png)
...
1. Configure an **Administrator Account** by setting up a password and optionally, an email address.
  ...
  ![Screenshot of Create Account screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT02.png)

2. Configure **System Settings** by specifying the backup passphrase and DNS information.

  ![Screenshot of System Settings screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT03.png)

3. (Optional) Configure **Email/SMTP**.

  ![Screenshot of Email/SMTP screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT04.png)
...
4. Configure **Multi-Tenant** settings as follows:
   ...
   ![Screenshot of Multi-Tenant screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT05.png)
...
1. Navigate to **Infrastructure > Clouds** and edit **Default-Cloud**.
  ...
  ![Screenshot of Infrastructure screen showing tabs](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT06.png)

2. Select **VMware vCenter/vSphere ESX** as the infrastructure type and click **Next**.

  ![Screenshot of the **Edit Clouds** screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT07.png)
...
3. On the **Infrastructure** tab, configure the following:
  ...
  ![Screenshot of Infrastructure tab on Edit Cloud screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT08.png)
...
4. Select the **Data Center** and configure the following:
   ...
   - For Virtual Service Placement, unselect **Prefer Static Routes vs Directly Connected Network***
    ...
    ![Screenshot of Data Center tab on Edit Cloud screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT09.png)
...
11. Configure the **Network** settings as follows:
   ...
   ![Screenshot of Network tab on Edit Cloud screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT10.png)

2. Ensure that the health of the Default-Cloud is green after configuration.

   ![Screenshot of Clouds tab on Infrastructure screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT11.png)
...
2. Click **Apply Key**. If you have a license file instead of a license key, click the **Upload from Computer** link.
  ...
  ![Screenshot of Licensing tab](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT12.png)

1. Click **Apply Key**.

  ![Screenshot of Apply License Key section of Licensing tab](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT13.png)
...
### Configure NTP Settings
 ...
 1. Go to the **Administration > Settings > DNS/NTP** page.
    ...
    ![Screenshot of DNS/NTP page](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT14.png)
...
1.  On the **Update System Settings** dialog, edit the settings for the NTP server that you want to use.
    ...
    ![Screenshot of Update System Settings dialog](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT15.png)
...
1. Specify a name for the controller cluster and set the cluster IP address. This IP address should be from the NSX Advanced Load Balancer management network.
   ...
   ![Screenshot of Controller tab on the Administration screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT16.png)
...
2. In **Cluster Nodes**, specify the IP addresses of the two additional controllers that you have deployed.
   ...
   ![Screenshot of Edit Controller Configuration dialog](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT17.png)
...
You are automatically logged out of the controller node you are currently logged in. Enter the cluster IP address in a browser to see the cluster formation task details.
   ...
   ![Screenshot of Controller Initializing screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT18.png)

The first controller of the cluster receives the "Leader" role. The second and third controllers will work as "Follower".

   ![Controller Role](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT19.png)
...
1. Navigate to the **Templates > Security > SSL/TLS Certificate >** and click **Create** and select **Controller Certificate**.
   ...
   ![Screenshot of the SSL/TSL Certificates tab](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT20.png)
...
2. Click **Save**.
    ...
    ![Controller New Certificate](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT21.png)
...
3. Change the NSX Advanced Load Balancer portal certificate.
   ...
   ![Screenshot of the New Certificate (SSL/TLS) window](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT22.png)
...
1. Click **Add Static IP Address Pool** to specify the IP address pool for the VIPs and Service Engine. The range must be a subset of the network CIDR configured in **IP Subnet**.
   ...
   ![Screenshot of Edit Network Settings screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT23.png)
...
1. Click **Create**.
  ...
  ![Screenshot of Infrastructure tabs](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT24.png)
...
4. Click **Save**.
  ...
  ![Screenshot of Edit Static Route screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT25.png)
...
2. Click **Create** and select **IPAM Profile** from the dropdown menu.
  ...
  ![Screenshot of the IPAM/DNS Profiles tab](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT26.png)
...
1. Click **Add Usable Network**.
   ...
   ![Screenshot of New IPAM/DNS Profile screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT27.png)
...
6. Click on the Create button again and select DNS Profile
   ...
   ![DNS Profile](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT27-1.jpg)
...
7. Assign the IPAM and DNS profile to the Default-Cloud configuration.
   ...
   ![Screenshot of Edit Cloud window](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT28.png)
...
1. Log in to the vSphere client and navigate to **Menu > Workload Management** and click **Get Started**.
  ...
  ![Screenshot of Workload Management screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT29.png)
...
2. Select the vCenter Server and Networking stack.
   ...
   ![Screenshot of Networking Stack](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT30.png)

3. Select a cluster from the list of compatible clusters and click **Next**.

   ![Screenshot of Cluster Selection](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT31.png)

3. Select the **Control Plane Storage Policy** for the nodes from the drop-down menu and click **Next**.

   ![Screenshot of storage settings](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT32.png)
...
4. On the **Load Balancer** screen, select **Load Balancer Type** as **NSX Advanced Load Balancer** and provide the following details:
   ...
   - **Server Certificate**: Use the content of the controller certificate that you exported earlier while configuring certificates for the controller.
    ...
    ![Screenshot of load balancer settings](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT33.png)  
...
6. On the **Management Network** screen, select the port group that you created on the distributed switch.
   ...
   - If DHCP is enabled for the port group, set the **Network Mode** to **DHCP**.
    ...
    ![Screenshot of Management Network screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT34.png)
...
8. On the **Workload Network** screen, select the network that will handle the networking traffic for Kubernetes workloads running on the Supervisor cluster.
   ...
   ![Screenshot of the Workload Network screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT35.png)
...
10. On the **Tanzu Kubernetes Grid Service** screen, select the subscribed content library that contains the Kubernetes images released by VMware.
     ...
     ![Screenshot of Tanzu Kubernetes Grid Service screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT36.png)
...
12. Click **Finish**. This triggers the Supervisor Cluster deployment.
     ...
     ![Screenshot of Review and Confirm screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT37.png)
...
The Supervisor Cluster gets an IP address from the VIP network that you configured in the NSX Advanced Load Balancer. This IP address is also called the Control Plane HA IP address.
   ...
   ![Screenshot of the Workload Clusters screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT38.png)
...
![Screenshot of the download page for Kubernetes CLI Tools](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT38-1.png)
...
3. Click **Create Namespace**.
  ...
  ![Screenshot of the Namespaces tab](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT39.png)
...
6. Click **Create**. The namespace is created on the Supervisor Cluster.
   ...
   ![Screenshot of the Create Namespace screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT40.png)
...
![Screenshot of Configure Permissions for the Namespace](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT41.png)
...
![Screenshot of Add Permissions window](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT42.png)
...
![Screenshot of the Select Storage Policies](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT43.png)
...
![Screenshot of the Resource Limits window](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT44.png)
...
1. Click **Add VM Class** for **VM Service.**
   ...
   ![Screenshot of VM Service window](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT45.png)

1. From the list of the VM Classes, select the classes that you want to include in your namespace.

   ![Screenshot of Add VM Class screen 1](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT46.png)

   ![Tanzu Kubernetes Grid Service** screen 2](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT47.png)
...
2. Go to **Administration > Management clusters > Register Management Cluster** tab and select vSphere with Tanzu.
   ...
   ![Screenshot of Tanzu Mission Control console](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT48.png)
...
2. On the Register management cluster page, provide a name for the management cluster, and choose a cluster group.
   ...
   ![Screenshot of Register management cluster](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT49.png)
...
3. If you are using a proxy to connect to the Internet, you can configure the proxy settings by toggling the Set proxy option to yes.
   ...
   ![Screenshot of proxy settings](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT50.png)
...
4. On the Register page, Tanzu Mission Control generates a YAML file that defines how the management cluster connects to Tanzu Mission Control for registration. The credential provided in the YAML expires after 48 hours.
   ...
   ![Screenshot of Register screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT51.png)
...
5. Login to vSphere Client and select the cluster which is enabled for Workload Management and navigate to the **Configure > TKG Service > Tanzu Mission Control** tab and enter the registration URL in the box provided and click **Register**.
   ...
   ![Screenshot of Tanzu Mission Control Registration screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT52.png)
   ...
   ![Screenshot Tanzu Mission Control Registration success screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT55.png)

6. Return to the Tanzu Mission Control console and click **Verify Connection**.

   ![Screenshot of Tanzu Mission Control console](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT53.png)
...
7. Clicking **View Management Cluster** takes you to the overview page which displays the health of the cluster and its components.
   ...
   ![Screenshot of the component health screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT54.png)
...
1. Go to the **Clusters** tab and click **Create Cluster**.
   ...
   ![Screenshot of Step 1: Creating a cluster](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT56.png)
...
1. On the **Create cluster** page, select the Supervisor cluster that you registered in the previous step and click on Continue to create cluster.
   ...
   ![Screenshot of Create cluster screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT57.png)
...
2. Select the provisioner for creating the workload cluster. Provisioner reflects the vSphere namespaces that you have created and associated with the Supervisor cluster.
   ...
   ![Screenshot of cluster provisioning screen](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT58.png)
...
1. Select the cluster group to which you want to attach your cluster. You can optionally enter a description and apply labels.
   ...
   ![Screenshot of Step 2: Name and Assign](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT59.png)
...
3. Configure the Cluster
   ...
   **Note:** This document doesn't cover the use of a proxy for vSphere with Tanzu. If your environment uses a proxy server to connect to the Internet, ensure the proxy configuration object includes the CIDRs for the pod, ingress, and egress from the workload network of the Supervisor Cluster in the **No proxy list**, as explained in [Create a Proxy Configuration Object for a Tanzu Kubernetes Grid Service Cluster Running in vSphere with Tanzu](https://docs.vmware.com/en/VMware-Tanzu-Mission-Control/services/tanzumc-using/GUID-B4760775-388A-45B5-A707-2191E9E4F41F.html#GUID-B4760775-388A-45B5-A707-2191E9E4F41F).
   ...
   ![Screenshot of Step 3: Configure](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT60.png)
...
4. Select the control plane.
   ...
   ![Step 4: Select control plane](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT61.png)
...
![Step 5: Edit and add node pools](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT62.png)
...
![Health screen for agent and extensions](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT63.png)
...
2. Go to the **Configure > Supervisor Cluster > General** page and enable the Namespace Service using the toggle button and setting the status to **Active**.
   ...
   ![Screenshot of enabling Namespace Service](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT64.png)

3. Configure the quota for the CPU/Memory/Storage and select the storage policy for the namespace.

   ![Screenshot of Namespace Service configuration](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT65.png)
...
4. On the permissions page, select the identity source (AD, LDAP, etc) where you have created the users and groups for the Developer/Cluster Administrator. On selecting the identity source, you can search for the user/groups in that identity source.
   ...
   ![Screenshot of Permissions page](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT66.png)

5. Review the settings and click **Finish** to complete the namespace service enable wizard.

   ![Screenshot of Review and Confirm page](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT67.png)

   The Namespace Self-Service is now activated and ready to be consumed.

   ![Screenshot of Namespace Service activation confirmation](/img/deployment-guides/tko-on-vsphere-with-tanzu/TKO-VWT68.png)
